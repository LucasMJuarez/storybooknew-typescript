...
function ChartFooter({title, subtitle, onClick, rightArrow, tabIndex, role, ariaLabel, onKeyPress}: ChartFooterProps) {
    return (
        <div
            data-testid='chart-footer-container'
            onClick={() => onClick?.()}
        ...
        >
            <div data-testid='title-container' className={rightArrow ? styles.inline : ''}>
                <Body text={title} data-testid='title' level={2} align='Center' type='text_button_tertiary' />
                {rightArrow && (
                    <svg
